...
/* Symbols to be used with PORT driver */
#define BOARD_INITADCPINS_sensor_luz_PORT PORTE                /*!<@brief PORT peripheral base pointer */
#define BOARD_INITADCPINS_sensor_luz_PIN 22U                   /*!<@brief PORT pin number */
#define BOARD_INITADCPINS_sensor_luz_PIN_MASK (1U << 22U)      /*!<@brief PORT pin mask */
                                                               /* @} */
